          ...
          <div className="max-w-[1400px] mx-auto px-6 md:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                ...
                {/* Instagram Follow */}
                <div className="mt-8 pt-8 border-t border-[#E1E1E1]">
                  <a
                    href="https://instagram.com/philo.homes"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-3 text-[#4B4B4B] hover:text-[#101A2E] transition-colors"
                  >
                    ...
                    <span className="text-sm">Follow us for designs, news, and upcoming launches</span>
                  </a>
                </div>
              </div>
            </div>
