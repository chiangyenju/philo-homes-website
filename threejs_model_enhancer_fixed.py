    ...
    def create_threejs_materials(self):
        ...
        if principled:
            ...
            if 'Specular' in principled.inputs:
                ...
                principled.inputs['IOR'].default_value = 1.5  # Typical fabric IOR
        ...
        if principled:
            ...
            if 'Specular' in principled.inputs:
                ...
                principled.inputs['IOR'].default_value = 1.6  # Typical leather IOR
        ...
        if principled:
            ...
            if 'Specular' in principled.inputs:
                ...
                principled.inputs['IOR'].default_value = 1.45  # Typical fabric IOR
        ...
        if principled:
            ...
            if 'Specular' in principled.inputs:
                ...
                principled.inputs['IOR'].default_value = 1.5  # Typical synthetic fabric IOR
...
class MESH_OT_enhance_threejs(Operator, ImportHelper):
    ...
    def execute(self, context):
        try:
            ...
            self.report({'INFO'}, f"Enhanced models saved to {bpy.path.abspath(os.path.expanduser(self.output_dir))}")
            return {'FINISHED'}
...
class MESH_OT_test_threejs(Operator):
    ...
    def execute(self, context):
        try:
            ...
            self.report({'INFO'}, "Three.js test enhancement completed successfully")
            return {'FINISHED'}
